...
//#define CONF_USB_CDCD_ACM_IDVENDER 0x03eb
#define CONF_USB_CDCD_ACM_IDVENDER 0x2890
#endif
...
#define CONF_USB_CDCD_ACM_IDPRODUCT 0x8022
#endif
...
#define CONF_USB_CDCD_ACM_IMANUFACT_STR "Teknic, Inc."
#endif

#ifndef CONF_USB_CDCD_ACM_IMANUFACT_STR_DESC
#define CONF_USB_CDCD_ACM_IMANUFACT_STR_DESC                                                   \
        26, 0x03, 'T', 0x00, 'e', 0x00, 'k', 0x00, 'n', 0x00, 'i', 0x00, 'c', 0x00, ',', 0x00, \
        ' ', 0x00, 'I', 0x00, 'n', 0x00, 'c', 0x00, '.', 0x00,
#endif
#if !CONF_USB_CDCD_ACM_IMANUFACT_EN
#undef CONF_USB_CDCD_ACM_IMANUFACT_STR_DESC
#define CONF_USB_CDCD_ACM_IMANUFACT_STR_DESC
#endif
...
#define CONF_USB_CDCD_ACM_IPRODUCT_STR "Teknic ClearCore"
#endif

#ifndef CONF_USB_CDCD_ACM_IPRODUCT_STR_DESC
#define CONF_USB_CDCD_ACM_IPRODUCT_STR_DESC                                                                                \
        34, 0x03, 'T', 0x00, 'e', 0x00, 'k', 0x00, 'n', 0x00, 'i', 0x00, 'c', 0x00, ' ', 0x00, 'C', 0x00, 'l', 0x00, 'e',  \
        0x00, 'a', 0x00, 'r', 0x00, 'C', 0x00, 'o', 0x00, 'r', 0x00, 'e', 0x00,
#endif
#if !CONF_USB_CDCD_ACM_IPRODUCT_EN
#undef CONF_USB_CDCD_ACM_IPRODUCT_STR_DESC
#define CONF_USB_CDCD_ACM_IPRODUCT_STR_DESC
#endif
...
#define CONF_USB_CDCD_ACM_ISERIALNUM_STR "123456789ABCDEF0123456789ABCDEF0"
#endif

#ifndef CONF_USB_CDCD_ACM_ISERIALNUM_STR_DESC
#define CONF_USB_CDCD_ACM_ISERIALNUM_STR_DESC                                                                             \
        66, 0x03, '1', 0x00, '2', 0x00, '3', 0x00, '4', 0x00, '5', 0x00, '6', 0x00, '7', 0x00, '8', 0x00, '9', 0x00, 'A', \
        0x00, 'B', 0x00, 'C', 0x00, 'D', 0x00, 'E', 0x00, 'F', 0x00, '0', 0x00, '1', 0x00, '2', 0x00, '3', 0x00, '4', 0x00, \
        '5', 0x00, '6', 0x00, '7', 0x00, '8', 0x00, '9', 0x00, 'A', 0x00, 'B', 0x00, 'C', 0x00, 'D', 0x00, 'E', 0x00,     \
        'F', 0x00, '0', 0x00,
#endif
#if !CONF_USB_CDCD_ACM_ISERIALNUM_EN
#undef CONF_USB_CDCD_ACM_ISERIALNUM_STR_DESC
#define CONF_USB_CDCD_ACM_ISERIALNUM_STR_DESC
#endif
...
#define CONF_USB_CDCD_ACM_BMAXPOWER 0xFA
#endif
// </h>
